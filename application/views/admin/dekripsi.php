        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark font-weight-bolder active" aria-current="page">Dekripsi
                    </li>
                </ol>
            </nav>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form class="d-flex flex-row justify-content-start"
                        action="<?= base_url('admin/dekripsi_proses') ?>" method="post">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <button class="btn bg-gradient-primary m-3" type="submit"
                                    type="button">Dekripsi</button>
                                <?php if ($total != 0) : ?>
                                <a href="<?= base_url('admin/hasildekripsi') ?>" class="btn bg-gradient-secondary m-3"
                                    type="button">Lihat Hasil Dekripsi</a>
                                <?php endif ?>
                            </div>
